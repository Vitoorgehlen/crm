...
import {
  addDocumentationCost,
  deleteDocumentationCost,
  getDocumentationCost,
  updateDocumentationCost,
} from "../repositories/documentationCostRepository";
...
router.put(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
      ...
      return res
        .status(500)
        .json({ error: "Erro ao atualizar o valor de documentação" });
    }
  },
);
