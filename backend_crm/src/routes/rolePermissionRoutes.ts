...
import {
  ...
  getRolePermissionsByCompany,
  resetRolePermissionsDefault,
...
router.put(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
      const updatedPermission = await updateRolePermission(
        userId,
        userRole,
        role,
        updates,
...
router.post(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
      const resetPermission = await resetRolePermissionsDefault(
        userId,
        userRole,
      );
