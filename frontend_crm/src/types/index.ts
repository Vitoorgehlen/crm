...
export const PermissionLabels: Record<string, string> = {
  ...
  USER_DESACTIVE: "Desativar usuário",
...
export const docsNames = [
  ...
  {
    key: "DEED_FINANCED_SBPE",
    label: "Escritura SBPE",
    type: "percent",
    value: 0,
  },
  {
    key: "DEED_FINANCED_MIN_SBPE",
    label: "Mínimo Escritura SBPE",
    type: "money",
    value: 0,
  },
  {
    key: "DEED_FINANCED_MCMV",
    label: "Escritura MCMV",
    type: "percent",
    value: 0,
  },
  {
    key: "DEED_FINANCED_MIN_MCMV",
    label: "Mínimo Escritura MCMV",
    type: "money",
    value: 0,
  },
...
export type FinancialMovementType = "INCOME" | "EXPENSE" | "COMMISSION";
