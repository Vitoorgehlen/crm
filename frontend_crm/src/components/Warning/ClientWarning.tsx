        ...
        <div className={styles.innerModal}>
          ...
          <div className={styles.line}>
            {confirmStep ? (
              <p className={styles.text}>
                ...
                <span className={styles.name}>{deals}</span>{" "}
                {deals > 1 ? "negociações" : "negociação"}?
              </p>
            ) : (
              <p>
          ...
          <div className={styles.footerCard}>
            <button
              ...
              onClick={onClose}
            >
              {loading === "cancel" ? <span>Cancelando...</span> : "Cancelar"}
            </button>
            ...
            <button
              ...
              onClick={() => {
                if (deals > 0 && !confirmStep) setConfirmStep(true);
                else handleConfirm();
              }}
            >
