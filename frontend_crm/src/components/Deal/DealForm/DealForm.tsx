...
import { Client, ClientStatus, Deal, DealFormProps, DealStatus, Note, PaymentMethod } from "@/types";
...
export default function DealForm({
  ...
  const [paymentMethod, setPaymentMethod] = useState<PaymentMethod>('FINANCING');
  ...
  const [loading, setLoading] = useState<'read' | 'addNote' | 'save' | 'del' | null>(null);
  ...
  return (
    <form className={mode === 'create' ? styles.overlay : styles.overlayEdit} 
        onClick={(e) => { 
            ...
            <div className={mode === 'create' ? styles.modal : styles.modalEdit} 
                onClick={(e) => e.stopPropagation()}>
                <div className={styles.innerModal}>
                <div className={styles.modalLeft}>
                    <div className={styles.titleCard}>
                        <button 
                        className={mode === 'create' ? styles.closeBtn : styles.closeBtnEdit}
                        type="button" 
                        onClick={(e) => onClose()}>
                            <MdClose />
                        </button>
                ...
                {mode === 'create' ? (
                    ...
                    {deal?.deleteRequest ?
                    <div className={styles.deleteRequest}>
                        Solicitado
                    </div>
                    :
                    <button 
                    ...
                    <div className={styles.modalRight}>
                        <div className={styles.noteSection}>
                            ...
                            <div className={styles.addNote}>
                                ...
                                <button type="button" className={styles.btnSave} onClick={handleAddNote} disabled={!newNote.trim()}>
                                    <RiSave3Fill />
                                </button>
                            </div>
            ...
            {isCloseOpen && deal && (
                <CloseDealForm
                    ...
                    newStep={async (step: string) => { /* noop */ }}
                />
                )}
        </div>
    </form>
